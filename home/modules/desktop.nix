...

{
  ...
  xdg.configFile."niri/config.kdl".text = ''
    ...
    binds {
        ...
        Mod+T hotkey-overlay-title="Open a Terminal: alacritty" { spawn "${pkgs.alacritty}/bin/alacritty"; }
        Mod+D hotkey-overlay-title="Run an Application: rofi" { spawn "${pkgs.rofi}/bin/rofi" "-show" "drun"; }
        Super+Alt+L hotkey-overlay-title="Lock the Screen: hyprlock" { spawn "${pkgs.hyprlock}/bin/hyprlock"; }
  ...
  home.packages = with pkgs; [
    ...
    wf-recorder
    # Media key controller used by the niri keybindings.
    playerctl
    # Backlight controller used by the niri keybindings.
    brightnessctl
